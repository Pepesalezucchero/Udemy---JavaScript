...
function calcAverageHumanAge(arr) {
  ...
  //Task 3
  const sumAges = adultHuman.reduce((acc, age) => acc + age, 0);
  const averageAge = sumAges / adultHuman.length;

  //Modo alternativo correzione
  // const sumAges = adultHuman.reduce((acc, age, i, arr) => acc + age / arr.length, 0);
  //return sumAges;
