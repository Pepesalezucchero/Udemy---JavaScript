...
const calcAverage = (play1, play2, play3) => (play1 + play2 + play3) / 3;

let dolphinsScore = calcAverage(44, 23, 71);
let koalasScore = calcAverage(65, 54, 49);

console.log(`Punteggio medio dei Dolphins: ${dolphinsScore}`);
console.log(`Punteggio medio dei Koalas: ${koalasScore}`);
