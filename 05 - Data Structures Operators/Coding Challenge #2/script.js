...
//Task 1
for([score, player] of game.scored.entries()) {
...
averageOdds /= Object.entries(game.odds).length;
console.log(Number(averageOdds.toFixed(2)));

//Task 3
for(let [result, odd]  of Object.entries(game.odds)) {
    if(result === 'team1'){
